...
def diagnose(error: dict, code_snippet: str) -> dict:
    """
    Given a structured error and its code context, ask the LLM to diagnose it.
...
Diagnose the root cause of this error and suggest a fix.
